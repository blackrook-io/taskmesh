...
- **versioning.mdc** — SemVer bump on finish-up (MINOR for schema-changing features, PATCH otherwise); `createdAt` vs PROD `releasedAt`; same-commit [`RELEASE_NOTES.md`](RELEASE_NOTES.md) update.
